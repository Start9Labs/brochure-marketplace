    ...
    resync: {
      ...
      'input-spec': {
        ...
        testnet: {
          ...
          type: 'boolean',
          description:
            '<ul><li>determines whether your node is running on testnet or mainnet</li></ul>',
